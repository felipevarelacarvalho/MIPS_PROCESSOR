...
C:\altera\intelFPGA\20.1\quartus\bin64\quartus_map --read_settings_files=on --write_settings_files=off qs2 -c qs2

C:\altera\intelFPGA\20.1\quartus\bin64\quartus_fit --read_settings_files=off --write_settings_files=off qs2 -c qs2
C:\altera\intelFPGA\20.1\quartus\bin64\quartus_asm --read_settings_files=off --write_settings_files=off qs2 -c qs2
C:\altera\intelFPGA\20.1\quartus\bin64\quartus_sta --sdc="qs2.sdc" qs2 --do_report_timing
'''

quartus_bin_dir = r'C:\intelFPGA\20.1\quartus\bin64'
